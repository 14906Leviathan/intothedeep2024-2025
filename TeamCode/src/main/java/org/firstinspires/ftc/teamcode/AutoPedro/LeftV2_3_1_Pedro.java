...
//
//@Disabled
//@Autonomous(name = "Left 3+1 V2 Pedro", group = "0", preselectTeleOp = "0: Main TeleOp")
//public class LeftV2_3_1_Pedro extends LinearOpMode {
...
//    private AutoLocation autoLocation = AutoLocation.PEDRO_LEFT_3_1_V2;
//    private int nextAutoState = 0;
//    private Telemetry telemetryA;
//    private Pose robotStartPose = new Pose(0, 0, 0);
//
//    public LeftV2_3_1_Pedro() {
//    }
//
...
////            autoManager.safeSleep(10000);
//        } else if (sampleNum == 2) {
//            autoManager.runPath(autoManager.intakeYellow2, false);
//        } else if (sampleNum == 3) {
//            autoManager.setSpeed(.7);
...
//
//        arm.intakeDownMode();
//        autoManager.waitForArmAndSlides(5000);
//
//        if(sampleNum == 3) {
//            arm.intakeDownMode();
//            autoManager.safeSleep(350);
