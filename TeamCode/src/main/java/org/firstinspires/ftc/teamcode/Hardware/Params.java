...
public class Params {
    ...
    public static final double SLOWMODE_XY_MULT = .4;
    public static final double SLOWMODE_TURN_MULT = .4;
    ...
    public static final double CLAW_OUTSIDE_GRAB_ANGLE = 1.5;
    public static final double CLAW_OUTSIDE_DROP_ANGLE = 70;
